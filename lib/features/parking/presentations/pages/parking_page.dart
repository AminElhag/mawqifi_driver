...
import 'package:mawqifi_driver/common/location.dart';
import 'package:mawqifi_driver/common_model/nearby_parking_model.dart';
import 'package:mawqifi_driver/common_widget/nothing_to_show_widget.dart';
import 'package:mawqifi_driver/common_widget/park_item.dart';
import 'package:mawqifi_driver/features/parking/presentations/cubit/parking/parking_cubit.dart';
import 'package:mawqifi_driver/features/parking/presentations/pages/parking_details_page.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return BlocConsumer<ParkingCubit, ParkingState>(
      listener: (context, state) {
        ...
        }else if (state is SelectParkingApiResultState){
          if (kDebugMode) {
            print("object");
          }
        }
                    ...
                    return ParkItem(
                      ...
                      onPressed: () {
                        QuickAlert.show(
                          ...
                          title: 'Confirm',
                          text: "Select this park as your work place",
                          backgroundColor: Colors.black,
                          titleColor: Colors.white,
                          textColor: Colors.white,
                          cancelBtnText: "No",
                          onConfirmBtnTap: () async {
                            Navigator.pop(context);
                            context.read<ParkingCubit>().selectParking(item.parkingId,Globs.udValueInt(PreferenceKey.userId));
                            return null;
                            },
                        );
                      },
