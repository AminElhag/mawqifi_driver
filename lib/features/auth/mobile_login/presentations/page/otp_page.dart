        ...
        listener: (context, state) {
          if (state is OtpHUDState) {
            ...
            QuickAlert.show(
              ...
              text:
                  "Sorry for that but please waiting for sometime, maybe the sms in the way to you",
            ...
            Globs.udStringSet(state.otpVerificationModel.profile!.fullName,
                PreferenceKey.fullName);
            Globs.udStringSet(state.otpVerificationModel.profile!.phoneNumber,
                PreferenceKey.phoneNumber);
            Globs.udStringSet(state.otpVerificationModel.profile!.homeAddress,
                PreferenceKey.homeAddress);
            Globs.udIntSet(state.otpVerificationModel.profile!.genderTypeId,
                PreferenceKey.genderTypeId);
