...
import 'package:mawqifi_driver/main.dart';
...
class SVKey {
  static const mainUrl = "http://165.232.123.221:9215";
  static const baseUrl = "$mainUrl/api/driver/";
  ...
  static const svSelectParking = "${svGetNearbyParking}/select";

  static const svBooking = "${baseUrl}booking";

  static const svDriveBooking = "${baseUrl}booking";
  static const svAcceptBooking = "${svDriveBooking}/accept";
  static const svCompleteBooking = "${svDriveBooking}/complete";
}
